#include <GroveDriverPack.h> // https://github.com/SeeedJP/GroveDriverPack/releases
...
#define ID                "wiolte"
#define OUT_TOPIC         "devices/" ID "/messages/events/"
#define IN_TOPIC          "devices/" ID "/messages/devicebound/#"
